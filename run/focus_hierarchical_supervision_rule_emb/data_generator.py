...
def data_generator(input_json_file, output_json_path, num_classes):
    ...
    path_prefix = root_path + '/all_in_one/data/data_train/{}/{}'.format(mission_data, mission_data)
...
if __name__ == '__main__':
    input_json_file = os.path.join(root_path, 'all_in_one/data/data_json/labeled-Focus4Project-189-2018.01.09-train.json')
    output_json_path = os.path.join(root_path, 'all_in_one/data/data_train/{}'.format(mission_data))
