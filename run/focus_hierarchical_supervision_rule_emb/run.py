...
from all_in_one.models.cnn_model_hierarchical_supervision_rule_emb import model_cnn_hierarchical_supervision_rule_emb as main_model
...
def train(train_data_path, valid_data_path, test_data_path, path_prefix, load_model=False):
    ...
    model_name = 'batch_size_{}-filter_num_{}-filter_lengths_{}-lossweights_{}-sepa_conv_{}-dim_rule_{}'.format(
        config['batch_size'],
        config['filter_num'],
...
def main(_):
    ...
    #                              'focus_hierarchical_supervision_rule_emb/'
    #                              'batch_size_1-norm_lim_3.0-grad_lim_5.0-filter_num_300/')
    train(train_data_path, valid_data_path, test_data_path, path_prefix, load_model=False)
