...
def data_generator(excel_name, data_name):
    ...
    test.build_cross_validation(modify_vocab=utils.prepro_vocab1, call_back=utils.sub_num_name_add_padding, reflush=False)


if __name__ == '__main__':
    data_generator('focus_sentence_2018.01.03.xlsx', 'focus_rnn')
